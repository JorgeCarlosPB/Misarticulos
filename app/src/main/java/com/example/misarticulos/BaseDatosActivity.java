...
public class BaseDatosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lectorImagenes = new ImageLoader(colaPeticiones, new ImageLoader.ImageCache() {
            //private final androidx.util.LruCache<String, Bitmap> cache = new android.support.v4.util.LruCache<String, Bitmap>(10);
        ...
        StringRequest peticion = new StringRequest(Request.Method.GET, "https://mis-articulos-1bbcb-default-rtdb.firebaseio.com/Articulos.json", new Response.Listener<String>() {
            @Override
